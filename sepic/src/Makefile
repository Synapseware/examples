...
#
# make wfuses = Write fuse settings for this program to the mcu
#
# make rfuses = Read current fuse values
#
...
#LIBS = -Wl,-u,utils -lutils
#LIBS = -lsyn	# Synapseware library :)
...
#export OPT
#export EVENT_FREQ
#export MAX_EVENT_RECORDS
#export TWI_SPEED BAUD
